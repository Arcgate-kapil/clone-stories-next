...
import { fetchCity, fetchCategories, fetchStoriesListing, fetchStoryListing, setIframeView, filterStoryListing, filterAllStoryListing, setLayoverPlayBtn, fetchMasterListing, setHindiView } from '../lib/features/blogSlice';
...
const VoicesDetailPage = (props) => {
  ...
  if (pathname.startsWith('/voices') && id) {
    const storyType = state.categories.find(v => v.category === id)?.title || '';

    storyListTitle = `Watch personal and brand video stories of ${storyType} professionals, startups & business owners from India`;
  }
  ...
  const handleBackClick = (e) => {
    e.preventDefault();
    router.push(state.isHindi ? '/hindi/voices' : '/voices');
    // router.back();
  }

  useEffect(() => {
    // Update title
    document.title = state.isHindi ? `भारत के ${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} प्रोफेशनल्स, स्टार्टअप्स और बिज़नेस ओनर्स की प्रेरक कहानियाँ।` : `${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} Professionals, Startups & Businesses from India | Video Stories & People`;
    // Update or create meta description
    let metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute('content', state.isHindi ? `भारत के ${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} प्रोफेशनल्स, स्टार्टअप्स और बिज़नेस ओनर्स की व्यक्तिगत एवं करियर यात्रा और व्यावसायिक ब्रांड कहानियां देखें।` : `Watch personal, career journey and business brand stories of ${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} professionals, startups & business owners from India. Discover interesting people. Discover interesting people.`);
    } else {
      metaDesc = document.createElement('meta');
      metaDesc.name = 'description';
      metaDesc.content = state.isHindi ? `भारत के ${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} प्रोफेशनल्स, स्टार्टअप्स और बिज़नेस ओनर्स की व्यक्तिगत एवं करियर यात्रा और व्यावसायिक ब्रांड कहानियां देखें।` : `Watch personal, career journey and business brand stories of ${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} professionals, startups & business owners from India. Discover interesting people. Discover interesting people.`;
    ...
    updateOrCreateMeta('og:title', state.isHindi ? `भारत के ${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} प्रोफेशनल्स, स्टार्टअप्स और बिज़नेस ओनर्स की प्रेरक कहानियाँ।` : `${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} Professionals, Startups & Businesses from India | Video Stories & People`);
    updateOrCreateMeta('og:description', state.isHindi ? `भारत के ${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} प्रोफेशनल्स, स्टार्टअप्स और बिज़नेस ओनर्स की व्यक्तिगत एवं करियर यात्रा और व्यावसायिक ब्रांड कहानियां देखें।` : `Watch personal, career journey and business brand stories of ${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} professionals, startups & business owners from India. Discover interesting people. Discover interesting people.`);
    ...
    // Update Twitter tags
    updateOrCreateMeta('twitter:title', state.isHindi ? `भारत के ${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} प्रोफेशनल्स, स्टार्टअप्स और बिज़नेस ओनर्स की प्रेरक कहानियाँ।` : `${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} Professionals, Startups & Businesses from India | Video Stories & People`);
    updateOrCreateMeta('twitter:description', state.isHindi ? `भारत के ${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} प्रोफेशनल्स, स्टार्टअप्स और बिज़नेस ओनर्स की व्यक्तिगत एवं करियर यात्रा और व्यावसायिक ब्रांड कहानियां देखें।` : `Watch personal, career journey and business brand stories of ${id.replace(/_/g, ' ').replace(/^(.)|\s+(.)/g, c => c.toUpperCase())} professionals, startups & business owners from India. Discover interesting people. Discover interesting people.`);
    ...
    <>
      ...
      <div>
        ...
        <ReactHlsPlayer
          ...
          url={voicesUrlExists ? `https://cdn.workmob.com/stories_workmob/category_videos/${id + '/' + id}.m3u8` : 'https://cdn.workmob.com/stories_workmob/web_home/story-category-default-video/story-category-default-video.m3u8'}
          poster='https://cdn.workmob.com/stories_workmob/web_home/category-bg.jpg'
          controls={false}
          autoPlay={true}
          preload='auto'
          muted={true}
        ...
        <img
          ...
          src='https://cdn.workmob.com/stories_workmob/web_home/category-bg.jpg'
        />
        ...
        {!state.isiFrameView && search != '?hideBanner=yes' && !state.storyListLoading && (
          <ErrorBoundary>
            <StoriesPageBanner
...
export default VoicesDetailPage;